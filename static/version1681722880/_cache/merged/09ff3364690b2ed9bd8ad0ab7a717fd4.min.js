...
if($(window).width()<=767){$('.col-menu-3.vertical-menu-left .menu-vertical-items').each(function(){var childDivId=$(this).data('toggle');$(this).append($('#'+childDivId).html());$('.menu-vertical-items .menu-vertical-child').hide();});}});});;require(['jquery'],function($){$(document).ready(function(){jQuery('.md-menu-close-btn').on('click',function(){jQuery('html').removeClass('nav-open');});});});